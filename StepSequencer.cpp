...
StepSequencer::StepData::~StepData() // Definition of StepData Destructor
{
    std::cout << "\x1B[33m\u2612\033[0m";
}

StepSequencer::~StepSequencer() // Definition of StepSequencer Destructor
{
...
int StepSequencer::step() 
{
    ...
    //if gate is on update member variable stage position else hold prev 
